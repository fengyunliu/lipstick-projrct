...
public class FaceDatabaseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        face_database_button = (Button)findViewById(R.id.face_database_button);
        face_database_button.getBackground().setAlpha(75);
        face_database_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (fileBuf == null){
                    Toast.makeText(FaceDatabaseActivity.this,"请选择一张照片",Toast.LENGTH_LONG).show();
                    return;
                }
                new Thread() {
                    @Override
...
//                            responseData = response.body().string();
                            // Start FaceDatabaseReactionActivity
                            Intent intent = new Intent(FaceDatabaseActivity.this,FaceDatabaseReactionActivity.class);
